...
function handleClientMessage(ws, data) {
  ...
  switch (data.type) {
    case 'player_info':
      ...
      console.log(
        `Player info updated: ${client.playerId} (${client.playerName})`
      );
    ...
    case 'prism_collected':
      ...
      if (prismIndex >= 0) {
        ...
        prismData.prisms[prismIndex].collectionTime =
    ...
    case 'place_prism':
      ...
      console.log(
        `New prism placed: ${newPrism.id} at ${newPrism.latitude}, ${newPrism.longitude}`
      );
