import { prohibitHighRiskDirective, requireConsentForNudge, capPushbackIntensity, evaluatePolicies } from "../src/policies";

const baseState = { safety: { allowPushback: true, maxIntensity: 0.7 }, bond: { trust: 0.5 } } as any;
